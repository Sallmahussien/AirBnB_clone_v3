...
def get_reviews_by_place_id(place_id):
    ...
    place_by_id: Place = places.get('Place.' + place_id)
...
def get_review_by_id(review_id):
    ...
    review_by_id: Review = reviews.get('Review.' + review_id)
...
def create_review(place_id):
    ...
    review = Review(user_id=body_request.get('user_id'),
                    text=body_request.get('text'),
                    place_id=place_id)
    storage.new(review)
    storage.save()
