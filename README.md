...
The project currently only implements the back-end console and static web interface.
...
|                                | BaseModel                            | FileStorage                                      | DBStorage                                        | User                                                             | State                             | City                              | Amenity                           | Place                                                                                                                                                                                                  | Review                            |
|--------------------------------|--------------------------------------|--------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------|-----------------------------------|-----------------------------------|-----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|
| **PUBLIC INSTANCE ATTRIBUTES** | `id`<br>`created_at`<br>`updated_at` |                                                  |                                                  | Inherits from `BaseModel`, `Base`                                | Inherits from `BaseModel`, `Base` | Inherits from `BaseModel`, `Base` | Inherits from `BaseModel`, `Base` | Inherits from `BaseModel`, `Base`                                                                                                                                                                      | Inherits from `BaseModel`, `Base` |
| **PUBLIC INSTANCE METHODS**    | `save`<br>`to_dict`<br>`delete`      | `all`<br>`new`<br>`delete`<br>`save`<br>`reload` | `all`<br>`new`<br>`delete`<br>`save`<br>`reload` | ""                                                               | ""                                | ""                                | ""                                | ""                                                                                                                                                                                                     | ""                                |
| **PUBLIC CLASS ATTRIBUTES**    |                                      |                                                  |                                                  | `email`<br>`password`<br>`first_name`<br>`last_name`<br>`places` | `name`<br>`cities`                | `state_id`<br>`name`<br>`places`  | `name`<br>`place_amenities`       | `city_id`<br>`user_id`<br>`name`<br>`description`<br>`number_rooms`<br>`number_bathrooms`<br>`max_guest`<br>`price_by_night`<br>`latitude`<br>`longitude`<br>`amenity_ids`<br>`reviews`<br>`amenities` | `place_id`<br>`user_id`<br>`text` |
| **PRIVATE CLASS ATTRIBUTES**   |                                      | `file_path`<br>`objects`                         | `engine`<br>`session`<br>`url_db`                |                                                                  |                                   |                                   |                                   |                                                                                                                                                                                                        |                                   |                                                                                                                                                                      |                                   |
...
[FileStorage](./models/engine/file_storage.py) or [DBStorage](./models/enging/db_storage.py).
...
In `DBStorage` mode, every time the backend is initialized, it
